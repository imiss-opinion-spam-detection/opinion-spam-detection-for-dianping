...
#pos_review = tp.seg_fil_senti_excel(r"C:\Python27\Review-Helpfulness-Prediction-master\main\Feature extraction module\Sentiment features\Machine learning features\seniment review set\pos_review.xlsx", 1, 1)
#neg_review = tp.seg_fil_senti_excel(r"C:\Python27\Review-Helpfulness-Prediction-master\main\Feature extraction module\Sentiment features\Machine learning features\seniment review set\neg_review.xlsx", 1, 1)
pos_review = tp.seg_fil_senti_excel(r"C:\Python27\Review-Helpfulness-Prediction-master\main\Feature extraction module\Sentiment features\Machine learning features\seniment review set\positive.xlsx", 1, 1)
neg_review = tp.seg_fil_senti_excel(r"C:\Python27\Review-Helpfulness-Prediction-master\main\Feature extraction module\Sentiment features\Machine learning features\seniment review set\negitive.xlsx", 1, 1)
...
## 选择排名靠前的信息量的词，number是特征的维度，通过不断调整直至最优
...
pickle.dump(BernoulliNB_classifier, open(r'C:\Python27\Review-Helpfulness-Prediction-master\main\Feature extraction module\Sentiment features\Machine learning features\xn1.pkl','w'))
