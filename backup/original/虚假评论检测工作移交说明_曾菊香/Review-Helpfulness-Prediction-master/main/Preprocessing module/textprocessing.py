...
def get_excel_data(filepath, sheetnum, colnum, para):
    ...
    sheet = table.sheets()[int(sheetnum)-1]
...
def seg_fil_excel(filepath, sheetnum, colnum):
    ...
    stopwords = get_txt_data('C:\JXZeng\summer_2016\sentiment\Review-Helpfulness-Prediction-master\main\Preprocessing module\stopword.txt', 'lines')
...
def seg_fil_senti_excel(filepath, sheetnum, colnum):
    ...
    sentiment_stopwords = get_txt_data('C:\JXZeng\summer_2016\sentiment\Review-Helpfulness-Prediction-master\main\Preprocessing module\sentiment_stopword.txt', 'lines')
