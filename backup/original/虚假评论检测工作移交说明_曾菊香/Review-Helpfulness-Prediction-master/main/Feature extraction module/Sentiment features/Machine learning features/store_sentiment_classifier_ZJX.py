...
"""
dimention = ['500', '1000', '1500', '2000', '2500']
for d in dimention:
    word_scores = create_word_bigram_scores()
    best_words = find_best_words(word_scores, int(d))
    posFeatures = pos_features(best_word_features_com)
...
# print 'GaussianNB`s accuracy is %f' %score(GaussianNB())
    ...
    #print 'NuSVC`s accuracy is %f' %score(NuSVC())
    print '\n'
store_classifier(BernoulliNB(), trainset, "C:\JXZeng\summer_2016\sentiment\Review-Helpfulness-Prediction-master\main\Feature extraction module\Sentiment features\Machine learning features\sentiment_classifier_ZJX0719.pkl")
"""
d = '1500'
word_scores = create_word_bigram_scores()
best_words = find_best_words(word_scores, int(d))
...
# print 'NuSVC`s accuracy is %f' %score(NuSVC())
print '\n'
store_classifier(MultinomialNB(), trainset, "C:\JXZeng\summer_2016\sentiment\Review-Helpfulness-Prediction-master\main\Feature extraction module\Sentiment features\Machine learning features\sentiment_classifier_ZJX0719b.pkl")