...
# Load dataset
review = tp.get_excel_data(r"C:\Users\hp\Desktop\temporal\test_review.xlsx", "1", "1", "data")
...
def store_sentiment_dictionary_score(review_set, storepath):     #存储情感分数#
	...
	f.close()
store_sentiment_dictionary_score(review, "C:\Users\hp\Desktop\temporal\test_reviews_score.xlsx")
