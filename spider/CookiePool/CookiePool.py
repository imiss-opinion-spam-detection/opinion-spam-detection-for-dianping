...
def GetCookie(url):
    ...
    try:
        ...
        headers = {  # set headers
            ...
            'DNT':"1",
            'Cookie':
                "JSESSIONID=814C1ABFB459E23812519F1BC7062650;"
                " cy=1;"
                " cye=shanghai;"
                " _hc.v=11fc5e2e-1471-0107-b144-5b3b6c5c7562.1472660735;"
                #" __utma=1.152832804.1472660736.1472660736.1472660736.1;"
                #" __utmb=1.3.10.1472660736;"
                #" __utmc=1;"
                #" __utmz=1.1472660736.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)"
                ,
